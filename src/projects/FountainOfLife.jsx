...
const FountainOfLife = () => {
  return (
    ...
    <section className="projectpage">
      ...
      <video className="project-photo1" src="src/projects/fountainOfLife.mp4" alt="Fountain of Life 3D animation" autoPlay loop muted></video>
      ...
      <div className="project-photogrid">
        <img className="project-allphotos" src='src/projects/FountainOfLifePhoto1.png' alt="Screenshot from Fountain of Life 3D Animation"></img>
        <img className="project-allphotos" src='src/projects/FountainOfLifePhoto2.png' alt="Screenshot from Fountain of Life 3D Animation"></img>
      </div>
