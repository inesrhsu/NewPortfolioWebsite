...
const HappyDumplingsSketch = (p5) =>{
  ...
  p5.draw = () => {
    ...
    for (var i = 0; i < 6; i++){
        ...
        for (var j = 0; j < 6; j++){
            ...
            p5.ellipse(0,10*ratio,60*ratio,35*ratio);
            p5.ellipse(-27*ratio,5*ratio,15*ratio,10*ratio);
            p5.ellipse(27*ratio,5*ratio,15*ratio,10*ratio);
            p5.ellipse(-20*ratio,0,20*ratio,15*ratio);
            p5.ellipse(20*ratio,0,20*ratio,15*ratio);
            p5.ellipse(-7*ratio,-4*ratio,20*ratio,15*ratio);
            p5.ellipse(7*ratio,-4*ratio,20*ratio,15*ratio);
            p5.stroke(10);
            p5.noFill();
  ...
  export default HappyDumplingsSketch;