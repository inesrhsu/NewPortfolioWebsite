...
const HappyDumplingsSketch3 = (p5) =>{
    ...
    for (var i = 0; i < 6; i++){//draw all dumplings
        ...
        for (var j = 0; j < 6; j++){
            ...
            p5.rotate(p5.radians(ang));//body formed by three ellipses
                     //1           //2                  //3                  //4                  
            p5.bezier( -40*ratio, 22*ratio, -15*ratio, -8*ratio, -40*ratio, -30*ratio, );
            // p5.ellipse(0,11*ratio,60*ratio,45*ratio);
            // p5.ellipse(0,-15*ratio,30*ratio,20*ratio);
            // p5.rotate(p5.radians(70));
            // p5.ellipse(9*ratio,-9*ratio,45*ratio,35*ratio);
            ...
            // // p5.translate(8*ratio, -20*ratio);
            // // p5.rotate(p5.radians(150));
            // // p5.ellipse(0*ratio,0*ratio,35*ratio,10*ratio);
            ...
            // p5.push();//right middle top
            // p5.translate((j*100 + 50)*ratio, (100*i + 50)*ratio);
            // p5.rotate(p5.radians(ang));
            // p5.translate(8*ratio, -24*ratio);
            // p5.rotate(p5.radians(50));
            // p5.ellipse(0*ratio,0*ratio,25*ratio,10*ratio);
            // p5.pop();
            ...
            // p5.push();//left middle top
            // p5.translate((j*100 + 50)*ratio, (100*i + 50)*ratio);
            // p5.rotate(p5.radians(ang));
            // p5.translate(-8*ratio, -24*ratio);
            // p5.rotate(p5.radians(130));
            // p5.ellipse(0*ratio,0*ratio,25*ratio,10*ratio);
            // p5.pop();
            ...
            // p5.translate((j*100 + 50)*ratio, (100*i + 50)*ratio);
            // p5.rotate(p5.radians(ang));
            // p5.translate(18*ratio, -14*ratio);
            // p5.rotate(p5.radians(110));
            // p5.ellipse(0*ratio,0*ratio,30*ratio,10*ratio);
            // p5.pop();
            ...
            // p5.translate((j*100 + 50)*ratio, (100*i + 50)*ratio);
            // p5.rotate(p5.radians(ang));
            // p5.translate(0*ratio, -26*ratio);
            // p5.rotate(p5.radians(90));
            // p5.ellipse(0*ratio,0*ratio,10*ratio,15*ratio);
            // p5.pop();
  ...
  export default HappyDumplingsSketch3;